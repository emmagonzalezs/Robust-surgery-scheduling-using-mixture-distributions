...
#
# # # Example usage
# prefix = "5-916"  # Adjust this as per your data
# distr = "normal"
#
# parameters_surgeries, mixture_params = mixture_distribution_multimodal(distr, prefix)
...
# procedures = ["5-916.a0", "5-916.a1", "5-916.a2", "5-916.a3", "5-916.a4", "5-916.a5"]
# # blues = plt.cm.Blues(np.linspace(0.4, 1, len(procedures)))
# # plt.figure(figsize=(12, 8))
# for mean, sd, procedure in zip(means, sds, procedures):
#     y = norm.pdf(x, mean, sd)
#     plt.plot(x, y, label=f'Procedure {procedure} (μ={mean:.2f}, σ={sd:.2f})')
#
...
# plt.title(f'Normal distributions for {prefix} surgeries', fontsize=20)
