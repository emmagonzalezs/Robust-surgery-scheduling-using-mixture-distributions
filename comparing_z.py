...
if __name__ == '__main__':
    ...
    #
        ...
        regret_results_alternate3 = pool.apply_async(run_regret_based, (surgery_scheduling, 3, 5, 'alternate'))
        regret_results_alternate7 = pool.apply_async(run_regret_based, (surgery_scheduling, 7, 5, 'alternate'))
        regret_results_alternate10 = pool.apply_async(run_regret_based, (surgery_scheduling, 10, 5, 'alternate'))
        regret_results_alternate15 = pool.apply_async(run_regret_based, (surgery_scheduling, 15, 5, 'alternate'))
        regret_results_alternate25 = pool.apply_async(run_regret_based, (surgery_scheduling, 25, 5, 'alternate'))
        regret_results_alternate50 = pool.apply_async(run_regret_based, (surgery_scheduling, 50, 5, 'alternate'))
        regret_results_alternate75 = pool.apply_async(run_regret_based, (surgery_scheduling, 75, 5, 'alternate'))
