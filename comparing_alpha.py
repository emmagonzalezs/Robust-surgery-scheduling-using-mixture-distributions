...
if __name__ == '__main__':
    surgery_scheduling2 = SurgeryScheduling(number_surgeries=400, distr="normal", number_of_ors=3, alpha=2)
    ...
    print(f'from called function waiting list: {surgery_scheduling2.waiting_list_mixture_surgeries}')
    print("individual waiting list:", surgery_scheduling2.waiting_list_individual_surgeries)
    ...
    or_capacity = surgery_scheduling2.max_capacity * surgery_scheduling2.number_of_ors * \
                  surgery_scheduling2.number_working_days

    print(f"Total surgery time: {surgery_scheduling2.total_surgery_time()/60} hours")
    ...
    #
        ...
        regret_results_alternate2 = pool.apply_async(run_regret_based, (surgery_scheduling2, 5, 5, 'alternate'))
        regret_results_alternate5 = pool.apply_async(run_regret_based, (surgery_scheduling5, 5, 5, 'alternate'))
        regret_results_alternate10 = pool.apply_async(run_regret_based, (surgery_scheduling10, 5, 5, 'alternate'))
        regret_results_alternate25 = pool.apply_async(run_regret_based, (surgery_scheduling25, 5, 5, 'alternate'))
        regret_results_alternate50 = pool.apply_async(run_regret_based, (surgery_scheduling50, 5, 5, 'alternate'))
        regret_results_alternate100 = pool.apply_async(run_regret_based, (surgery_scheduling100, 5, 5, 'alternate'))

        best_schedule_output_alternate7, best_schedule_overtime_output_alternate7, regret_based_sampling_time_alternate7, \
        total_slack_regret_based_alternate7, total_free_time_regret_based_alternate7, total_free_days_regret_alternate7 = regret_results_alternate2.get()

        best_schedule_output_alternate10, best_schedule_overtime_output_alternate10, regret_based_sampling_time_alternate10, \
        total_slack_regret_based_alternate10, total_free_time_regret_based_alternate10, total_free_days_regret_alternate10 = regret_results_alternate5.get()
        ...
        total_slack_regret_based_alternate100, total_free_time_regret_based_alternate100, total_free_days_regret_alternate100 = regret_results_alternate100.get()
