...
class SurgeryScheduling:
    def __init__(self, number_surgeries, distr, number_of_ors):
        ...
        self.number_working_days = 80  # approx. 4 months
...
if __name__ == '__main__':
    ...
    def save_schedule_to_pickle(schedule, filename):
    ...
    with Pool(cpu_count()) as pool:
        ...
        # regret_results_original = pool.apply_async(run_regret_based, (surgery_scheduling, 100, 10, 'original'))
        # Run regret_based_sampling with alternate slack method
        # regret_results_alternate = pool.apply_async(run_regret_based, (surgery_scheduling, 100, 10, 'alternate'))
    ...
    # print("Parameter setting regret based: z=50, samples=15, ORs=3, alpha=50, 400 surgeries, 3 months (5 working days): 60 days, overtime probability=0.3")
    ...
    # # print("Parameter setting regret based: z=50, samples=15, ORs=3, alpha=50, 400 surgeries, 3 months (5 working days)")
...
# Save each schedule in a separate pickle file
#     save_schedule_to_pickle(ff_schedule_original, 'ff_schedule_original_try_new_p.pkl')
#     save_schedule_to_pickle(ff_schedule_alternate, 'ff_schedule_alternate.pkl')
    # save_schedule_to_pickle(lpt_schedule_original, 'lpt_schedule_original_try_new_p.pkl')
    save_schedule_to_pickle(lpt_schedule_alternate, 'lpt_schedule_alternate.pkl')
    # save_schedule_to_pickle(best_schedule_output_original, 'regret_schedule_original_try_new_p.pkl')
    # save_schedule_to_pickle(best_schedule_output_alternate, 'regret_schedule_alternate.pkl')
