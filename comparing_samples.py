...
class SurgeryScheduling:
    def __init__(self, number_surgeries, distr, number_of_ors, alpha):
        ...
        self.number_working_days = 80  # approx. 3 months = 60, 4 months: 80 days
...
if __name__ == '__main__':
    surgery_scheduling = SurgeryScheduling(number_surgeries=400, distr="normal", number_of_ors=3, alpha=100)
    # surgery_scheduling5 = SurgeryScheduling(number_surgeries=400, distr="normal", number_of_ors=3, alpha=5)
    # surgery_scheduling10 = SurgeryScheduling(number_surgeries=400, distr="normal", number_of_ors=3, alpha=10)
    # surgery_scheduling25 = SurgeryScheduling(number_surgeries=400, distr="normal", number_of_ors=3, alpha=25)
    # surgery_scheduling50 = SurgeryScheduling(number_surgeries=400, distr="normal", number_of_ors=3, alpha=50)
    # surgery_scheduling100 = SurgeryScheduling(number_surgeries=400, distr="normal", number_of_ors=3, alpha=100)
    ...
    #
        ...
        regret_results_alternate3 = pool.apply_async(run_regret_based, (surgery_scheduling, 100, 10, 'alternate'))
        regret_results_alternate7 = pool.apply_async(run_regret_based, (surgery_scheduling, 100, 15, 'alternate'))
        regret_results_alternate10 = pool.apply_async(run_regret_based, (surgery_scheduling, 100, 25, 'alternate'))
        regret_results_alternate15 = pool.apply_async(run_regret_based, (surgery_scheduling, 100, 35, 'alternate'))
        regret_results_alternate25 = pool.apply_async(run_regret_based, (surgery_scheduling, 100, 50, 'alternate'))
        regret_results_alternate50 = pool.apply_async(run_regret_based, (surgery_scheduling, 100, 100, 'alternate'))
        # regret_results_alternate75 = pool.apply_async(run_regret_based, (surgery_scheduling, 100, 150, 'alternate'))
        # regret_results_alternate100 = pool.apply_async(run_regret_based, (surgery_scheduling, 100, 5, 'alternate'))

        best_schedule_output_alternate7, best_schedule_overtime_output_alternate7, regret_based_sampling_time_alternate7, \
        total_slack_regret_based_alternate7, total_free_time_regret_based_alternate7, total_free_days_regret_alternate7 = regret_results_alternate3.get()

        best_schedule_output_alternate10, best_schedule_overtime_output_alternate10, regret_based_sampling_time_alternate10, \
        total_slack_regret_based_alternate10, total_free_time_regret_based_alternate10, total_free_days_regret_alternate10 = regret_results_alternate7.get()

        best_schedule_output_alternate15, best_schedule_overtime_output_alternate15, regret_based_sampling_time_alternate15, \
        total_slack_regret_based_alternate15, total_free_time_regret_based_alternate15, total_free_days_regret_alternate15 = regret_results_alternate10.get()

        best_schedule_output_alternate25, best_schedule_overtime_output_alternate25, regret_based_sampling_time_alternate25, \
        total_slack_regret_based_alternate25, total_free_time_regret_based_alternate25, total_free_days_regret_alternate25 = regret_results_alternate15.get()
        #
        best_schedule_output_alternate50, best_schedule_overtime_output_alternate50, regret_based_sampling_time_alternate50, \
        total_slack_regret_based_alternate50, total_free_time_regret_based_alternate50, total_free_days_regret_alternate50 = regret_results_alternate25.get()

        best_schedule_output_alternate100, best_schedule_overtime_output_alternate100, regret_based_sampling_time_alternate100, \
        total_slack_regret_based_alternate100, total_free_time_regret_based_alternate100, total_free_days_regret_alternate100 = regret_results_alternate50.get()

        # best_schedule_output_alternate75, best_schedule_overtime_output_alternate75, regret_based_sampling_time_alternate75, \
        # total_slack_regret_based_alternate75, total_free_time_regret_based_alternate75, total_free_days_regret_alternate75 = regret_results_alternate75.get()

        # best_schedule_output_alternate1000, best_schedule_overtime_output_alternate1000, regret_based_sampling_time_alternate1000, \
        # total_slack_regret_based_alternate1000, total_free_time_regret_based_alternate1000, total_free_days_regret_alternate1000 = regret_results_alternate100.get()
...
# # Print results for original slack method
    ...
    # print(f"Total overtime using lpt: {overtime_lpt_alternate / 60} hours")
    # print(f"Total overtime for lpt (in free time function): {total_free_time_lpt_alternate[1] / 60} hours")
    print(f"Total overtime using regret based: {best_schedule_overtime_output_alternate100 / 60} hours")
    print(
        f"Total overtime for regret based (in free time function): {total_free_time_regret_based_alternate100[1] / 60} hours")

    # print(f"Overtime occurred in {total_free_time_ff_alternate[2]} OR-plans for ff")
    # print(f"Overtime occurred in {total_free_time_lpt_alternate[2]} OR-plans for lpt")
    print(f"Overtime occurred in {total_free_time_regret_based_alternate100[2]} OR-plans for lpt")
    #
    # print(f"Total free time for ff: {total_free_time_ff_alternate[0] / 60} hours")
    # print(f"Total free time for lpt: {total_free_time_lpt_alternate[0] / 60} hours")
    # print(f'Total free time lpt within lpt function: {free_time_lpt_alternate / 60} hours')
    print(f"Total free time for regret based: {total_free_time_regret_based_alternate100[0] / 60} hours")
    #
    # print(f"Total running time for ff: {ff_time_alternate / 60} minutes")
    # print(f"Total running time for lpt: {lpt_time_alternate / 60} minutes")
    print(f"Total running time for regret based: {regret_based_sampling_time_alternate100/ 60} minutes")
    #
    # print(f"Total planned slack for ff: {total_slack_ff_alternate / 60} hours")
    # print(f"Total planned slack for lpt: {total_slack_lpt_alternate / 60} hours")
    print(f"Total planned slack for regret based: {total_slack_regret_based_alternate100 / 60} hours")
    #
    # print(f"Total free OR-plans for ff: {total_free_days_ff_alternate} days")
    # print(f"Total free OR-plans for lpt: {total_free_days_lpt_alternate} days")
    print(f"Total free OR-plans for regret_based: {total_free_days_regret_alternate100} days")
    ...
    # # print(f"Total overtime using lpt: {overtime_lpt_alternate / 60} hours")
    # # print(f"Total overtime for lpt (in free time function): {total_free_time_lpt_alternate[1] / 60} hours")
    # print(f"Total overtime using regret based: {best_schedule_overtime_output_alternate75 / 60} hours")
    # print(
    #     f"Total overtime for regret based (in free time function): {total_free_time_regret_based_alternate75[1] / 60} hours")
    #
    # # print(f"Overtime occurred in {total_free_time_ff_alternate[2]} OR-plans for ff")
    # # print(f"Overtime occurred in {total_free_time_lpt_alternate[2]} OR-plans for lpt")
    # print(f"Overtime occurred in {total_free_time_regret_based_alternate75[2]} OR-plans for lpt")
    # #
    # # print(f"Total free time for ff: {total_free_time_ff_alternate[0] / 60} hours")
    # # print(f"Total free time for lpt: {total_free_time_lpt_alternate[0] / 60} hours")
    # # print(f'Total free time lpt within lpt function: {free_time_lpt_alternate / 60} hours')
    # print(f"Total free time for regret based: {total_free_time_regret_based_alternate75[0] / 60} hours")
    # #
    # # print(f"Total running time for ff: {ff_time_alternate / 60} minutes")
    # # print(f"Total running time for lpt: {lpt_time_alternate / 60} minutes")
    # print(f"Total running time for regret based: {regret_based_sampling_time_alternate75 / 60} minutes")
    # #
    # # print(f"Total planned slack for ff: {total_slack_ff_alternate / 60} hours")
    # # print(f"Total planned slack for lpt: {total_slack_lpt_alternate / 60} hours")
    # print(f"Total planned slack for regret based: {total_slack_regret_based_alternate75 / 60} hours")
    # #
    # # print(f"Total free OR-plans for ff: {total_free_days_ff_alternate} days")
    # # print(f"Total free OR-plans for lpt: {total_free_days_lpt_alternate} days")
    # print(f"Total free OR-plans for regret_based: {total_free_days_regret_alternate75} days")
    ...
    # # print(f"Total overtime using lpt: {overtime_lpt_alternate / 60} hours")
    # # print(f"Total overtime for lpt (in free time function): {total_free_time_lpt_alternate[1] / 60} hours")
    # print(f"Total overtime using regret based: {best_schedule_overtime_output_alternate1000 / 60} hours")
    # print(
    #     f"Total overtime for regret based (in free time function): {total_free_time_regret_based_alternate1000[1] / 60} hours")
    #
    # # print(f"Overtime occurred in {total_free_time_ff_alternate[2]} OR-plans for ff")
    # # print(f"Overtime occurred in {total_free_time_lpt_alternate[2]} OR-plans for lpt")
    # print(f"Overtime occurred in {total_free_time_regret_based_alternate1000[2]} OR-plans for lpt")
    # #
    # # print(f"Total free time for ff: {total_free_time_ff_alternate[0] / 60} hours")
    # # print(f"Total free time for lpt: {total_free_time_lpt_alternate[0] / 60} hours")
    # # print(f'Total free time lpt within lpt function: {free_time_lpt_alternate / 60} hours')
    # print(f"Total free time for regret based: {total_free_time_regret_based_alternate1000[0] / 60} hours")
    # #
    # # print(f"Total running time for ff: {ff_time_alternate / 60} minutes")
    # # print(f"Total running time for lpt: {lpt_time_alternate / 60} minutes")
    # print(f"Total running time for regret based: {regret_based_sampling_time_alternate1000 / 60} minutes")
    # #
    # # print(f"Total planned slack for ff: {total_slack_ff_alternate / 60} hours")
    # # print(f"Total planned slack for lpt: {total_slack_lpt_alternate / 60} hours")
    # print(f"Total planned slack for regret based: {total_slack_regret_based_alternate1000 / 60} hours")
    # #
    # # print(f"Total free OR-plans for ff: {total_free_days_ff_alternate} days")
    # # print(f"Total free OR-plans for lpt: {total_free_days_lpt_alternate} days")
    # print(f"Total free OR-plans for regret_based: {total_free_days_regret_alternate1000} days")
